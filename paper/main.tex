...
6. We define a fiducial scale of homogeneity of $R_{\rm in }=50$\hMpc to
...
7. These different values for the force ration also hints towards
...
8. However until now we have focused on statistics derived over the
