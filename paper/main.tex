...
\newcommand{\hMsun}{{\ifmmode{h^{-1}{\rm M_{\odot}}}\else{$h^{-1}$M$_{\odot}$}\fi}}
...
\ref{fig:spheres_nbody} shows the distribution of $F_{\rm out}/F_{rm
  in}$ for spheres centered on 1000 random halos in the
simulation. Due to the mass distribution in cosmological volumes most
of them should correspond to halos with masses a few times the Milky Way mass
range. This shows that the most common expectation in the LCDM
cosmological model is that the force produced by the massive halos
distribution out to scales of $500$\hMpc is $\sim 10$ times that of the
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\linewidth,angle=0]{spheres_nbody_82_300_1000.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\linewidth,angle=0]{spheres_nbody_norm_MW_82_300_1000.pdf}
\caption{\label{fig:spheres_nbody} Force produced by 
  halos inside a spherical shell with radial distances $50\hMpc <
  R < 500\hMpc$ normalized to the force produced by a MW-like dark
  matter halo of $10^{12}$\hMsun located at $1$\hMpc. The forces are
  measured on $1000$ dark matter halos randomly selected in the
  simulation volume.}
\end{center}
\end{figure}
